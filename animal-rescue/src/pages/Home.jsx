        ...
        <Container className='content'>
            <Row className='intro'>
                <Col>
                    ...
                    <p>
                        Please visit our other pages to <span onClick={renderDonate} className='donate-link'>Learn more</span> about our mission, our animals, and how you can help us continue to provide a safe haven for animals in need.
                    </p>
                </Col>
            </Row>
        </Container>
